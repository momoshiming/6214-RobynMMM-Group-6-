...
plot_adstock(plot = TRUE)#(Figure 4.1: Theta and Scale change the Shape of Decay Rate)
plot_saturation(plot = TRUE)#(Figure 4.2: Alpha and Gamma Changes the Shape of Response Curve)
...
################################################################
#### Step 4: Train and Test by using Model refresh##############

OutputCollect$allSolutions #get all model IDs in result
# Pick one of the models from OutputCollect to proceed
#select_model <- "1_262_5"
#select_model <- "2_286_6"
#select_model <- "3_198_5"
#select_model <- "3_180_1"
...
#2021.1.1-2022.4 as training dataset and testing 2022.4-2022.7 as a test dataset
